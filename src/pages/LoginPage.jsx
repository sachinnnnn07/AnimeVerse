      ...
      >
        ...
        <div className="glass-strong rounded-3xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border transition-all hover:shadow-md"
          ...
          >
            ...
            <span className="text-sm font-medium" style={{ color: 'var(--page-text)' }}>Sign in with Google</span>
          </button>
        </div>
